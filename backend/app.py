...
def startup():
    ...
    app.run(port=app_config['app']['port'], use_reloader=True, debug=True)

def get_traceroutes(src, dest, start, end):
    ...
    # traceroutes_metric_range_data = MetricsList(metric_data) # metric_object_list will be initialized as
    ...
    # for item in traceroutes_metricslist:
    #     print(item, "\n")
